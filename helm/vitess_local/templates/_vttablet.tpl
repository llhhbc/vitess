...
- name: "init-mysql"
  image: "llh.com/vitess/mysqlctld:{{$vitessTag}}"
  ...
  args:
    ...
    - |
      ...
      # ensure vtdata
      #rm -rf /totalvtdata/$HOSTNAME
      mkdir -p /totalvtdata/$HOSTNAME
      ln -sf /totalvtdata/$HOSTNAME  /vtdataroot/tabletdata
      ...
      chown 1000:2000 -R /totalvtdata /vtdataroot
{{- end -}}
...
- name: init-vttablet
  image: "llh.com/vitess/vtctl:{{$vitessTag}}"
  imagePullPolicy: IfNotPresent
  volumeMounts:
    - name: vtdataroot
      mountPath: "/vtdataroot"
...
- name: vttablet
  image: "llh.com/vitess/vttablet:{{$vitessTag}}"
